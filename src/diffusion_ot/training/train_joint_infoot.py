            ...
            **({"conditional_projection": result.metrics} if cross_cost_source == "encoder" else
            ...
            "projection_probe": {
                ...
                **({"teacher_temperature": teacher_temperature, "structure_cost_scale": cost_scale}
                ...
                "recovery_iteration_budget": solver_options["recovery_iterations"],
        ...
        if step == initial_step + 1 or step % log_every == 0 or diagnostics_due:
            metrics = {
                ...
                **({"pcgrad": pcgrad_metrics} if pcgrad_metrics is not None else {}),
                ...
                "infoot_recovery_iteration_budget": solver_options["recovery_iterations"],
                "infoot_recovery_iterations": solution.recovery_iterations,
                "infoot_effective_projection_tolerance": solution.effective_projection_tolerance,
