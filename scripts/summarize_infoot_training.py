...
def validation_row(row: dict) -> dict:
    ...
    result = {"step": row["step"], "conditional_kl": row.get("conditional_structure_loss"),
              ...
              "solver_recovery_iteration_budget": probe.get("recovery_iteration_budget"),
              "solver_recovery_iterations": probe.get("recovery_iterations"),
              "solver_effective_projection_tolerance": probe.get("effective_projection_tolerance"),
              "solver_projection_iteration_budget": probe.get("projection_iteration_budget"),
              "solver_projection_tolerance": probe.get("projection_tolerance"),
...
def training_row(row: dict) -> dict:
    ...
    result = {"step": row["step"], "window_updates": row.get("window_updates"),
              ...
              "solver_recovery_iteration_budget": row.get("infoot_recovery_iteration_budget"),
              "solver_recovery_iterations": row.get("infoot_recovery_iterations"),
              "solver_effective_projection_tolerance": row.get("infoot_effective_projection_tolerance"),
              "window_solver_iterations": window.get("infoot_iterations"),
              "window_solver_recovery_iterations": window.get("infoot_recovery_iterations"),
              "window_solver_recovery_fraction": window.get("infoot_recovery_used"),
              "solver_projection_iteration_budget": row.get("infoot_projection_iteration_budget"),
              "solver_projection_tolerance": row.get("infoot_projection_tolerance"),
